...
public class XLSFileReader implements Serializable {
	...
	public XLSFileReader(YamlUtil feed, String feed_ids) throws IOException {
		feeds = feed;
		feed_id = feed_ids;
	...
	public List<JSONObject> read(HSSFWorkbook wb, String file) throws ParseException, IOException {
	...
	public List<JSONObject> melt(HSSFWorkbook wb, String file) throws ParseException, IOException {
